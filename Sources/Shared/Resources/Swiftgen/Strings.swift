...
public enum L10n {
  ...
  public enum About {
    ...
    public enum HomeAssistantOnFacebook {
      /// Be Ready Assistant on Facebook
  ...
  public enum Alerts {
    public enum ActionAutomationEditor {
      public enum Unavailable {
        /// To automatically create an automation for an Action please update your Be Ready Assistant to at least version 2024.2
        public static var body: String { return L10n.tr("Localizable", "alerts.action_automation_editor.unavailable.body") }
        /// Please update Be Ready Assistant
  ...
  public enum Connection {
    public enum Error {
      ...
      public enum FailedConnect {
        ...
        /// We couldn't connect to Be Ready Assistant
        ...
        public enum Cloud {
          /// Make sure your Be Ready Assistant Cloud subscription is active and connected to your server, you can verify that at [Nabu Casa](https://account.nabucasa.com)
        ...
        public enum CloudInactive {
          /// You have disabled Be Ready Assistant Cloud use in the app, if you need it for remote access please open companion app settings and enable it.
    ...
    public enum Permission {
      public enum InternalUrl {
        /// To access Be Ready Assistant locally in a secure way, you need to grant the location permission ('Always').
        public static var body1: String { return L10n.tr("Localizable", "connection.permission.internal_url.body1") }
        /// This permission allows Be Ready Assistant to detect the wireless network that you're connected to and establish a local connection.
        public static var body2: String { return L10n.tr("Localizable", "connection.permission.internal_url.body2") }
        /// You are always in control if your location is shared with Be Ready Assistant. You can change these settings in the companion app setting screen.
  ...
  public enum DeviceName {
    /// This is used to identify your device in your Be Ready Assistant.
  ...
  public enum Gestures {
    ...
    public enum Screen {
      /// Gestures below will be applied whenever you are using Be Ready Assistant main UI.
  ...
  public enum HaApi {
    public enum ApiError {
      ...
      /// Received invalid response from Be Ready Assistant
      ...
      /// The mobile_app component is not loaded. Please add it to your configuration, restart Be Ready Assistant, and try again.
      ...
      /// Your Be Ready Assistant version (%@) is too old, you must upgrade to at least version %@ to use the app.
    ...
    public enum ItemType {
      public enum Action {
        public enum List {
          ...
          public enum Warning {
            /// We will stop supporting iOS Actions in the future, please consider using Be Ready Assistant scripts or scenes instead.
  ...
  public enum Nfc {
    ...
    public enum List {
      ...
      /// 
      /// Tags will work on any device with Be Ready Assistant installed which has hardware support to read them.
    ...
    public enum Read {
      ...
      public enum Error {
        ...
        /// NFC tag is not a Be Ready Assistant tag
    ...
    public enum Action {
      public enum Rows {
        public enum AuthenticationRequired {
          /// When the user selects an action with this option, the system prompts the user to unlock the device. After unlocking, Be Ready Assistant will be notified of the selected action.
  ...
  public enum Onboarding {
    ...
    public enum ManualSetup {
      ...
      /// The URL of your Be Ready Assistant server. Make sure it includes the protocol and port.
      ...
      public enum TextField {
        ...
        /// Your Be Ready Assistant URL
        public static var title: String { return L10n.tr("Localizable", "onboarding.manual_setup.text_field.title") }
      }
    }
    public enum Permission {
      public enum Location {
        /// To identify if you are at home and connect locally to Be Ready Assistant, Apple requires that we ask for your location permission.
        public static var description: String { return L10n.tr("Localizable", "onboarding.permission.location.description") }
        /// Your location won't be shared with your local Be Ready Assistant server unless you select 'Allow & Share with Be Ready Assistant'. You can choose to share later in companion app settings > sensors.
        public static var privacyNote: String { return L10n.tr("Localizable", "onboarding.permission.location.privacy_note") }
        public enum Buttons {
          /// Allow & Share with Be Ready Assistant
        ...
        public enum Deny {
          public enum Alert {
            /// If you are sure, please continue and tap 'Deny' on the next popup as well, in case you don't have a remote connection configured, the App will use your local connection configuration to access Be Ready Assistant.
    ...
    public enum Permissions {
      ...
      public enum Focus {
        /// Allow whether you are in focus mode to be sent to Be Ready Assistant
      ...
      public enum Motion {
        /// Allow motion activity and pedometer data to be sent to Be Ready Assistant
      ...
      public enum Notification {
        /// Allow push notifications to be sent from your Be Ready Assistant
    ...
    public enum Welcome {
      /// Allows you to access your Be Ready Assistant installation on the go. It runs locally in your home.
      public static var body: String { return L10n.tr("Localizable", "onboarding.welcome.body") }
      /// Connect to my Be Ready Assistant
      public static var continueButton: String { return L10n.tr("Localizable", "onboarding.welcome.continue_button") }
      /// This app connects to your Be Ready Assistant server and allows integrating data about you and your phone.
      /// 
      /// Be Ready Assistant is free and open source home automation software with a focus on local control and privacy.
      public static var description: String { return L10n.tr("Localizable", "onboarding.welcome.description") }
      /// Get started with Be Ready Assistant
      public static var getStarted: String { return L10n.tr("Localizable", "onboarding.welcome.get_started") }
      /// Be Ready Assistant Companion App
  ...
  public enum Permission {
    ...
    public enum Screen {
      public enum Bluetooth {
        ...
        /// The Be Ready Assistant app can find devices using Bluetooth of this device. Allow Bluetooth access for the Be Ready Assistant app.
  ...
  public enum Settings {
    public enum ConnectionSection {
      ...
      /// Directly connect to the Be Ready Assistant server for push notifications when on internal SSIDs.
    ...
    public enum Debugging {
      ...
      public enum Thread {
        /// Check what Thread credentials are inside Apple Keychain, you can also import in Be Ready Assistant or delete from Keychain.
    ...
    public enum ResetSection {
      public enum ResetAlert {
        /// Your settings will be reset and this device will be unregistered from push notifications as well as removed from your Be Ready Assistant configuration.
  ...
  public enum SettingsDetails {
    ...
    public enum Privacy {
      ...
      public enum Analytics {
        /// Allows collection of basic information about your device and interactions with the app. No user identifiable data is shared, including your Be Ready Assistant URLs and tokens. You must restart the app for changes to this setting to take effect.
  ...
  public enum SettingsSensors {
    /// Decide which of your device sensors you want to share with Be Ready Assistant.
  ...
  public enum Thread {
    ...
    public enum Credentials {
      ...
      /// Share credential with Be Ready Assistant
    ...
    public enum TransterToHomeassistant {
      /// Transfer to Be Ready Assistant
  ...
  public enum WebView {
    public enum EmptyState {
      /// Please check your connection or try again later. If Be Ready Assistant is restarting it will reconnect after it is back online.
  ...
  public enum Widgets {
    ...
    public enum Actions {
      /// Perform Be Ready Assistant actions.
    ...
    public enum Controls {
      public enum Assist {
        /// Open Assist in Be Ready Assistant app
    ...
    public enum Details {
      /// Display states using from Be Ready Assistant in text
      public static var description: String { return L10n.tr("Localizable", "widgets.details.description") }
      /// Display states using from Be Ready Assistant in text. ATTENTION: User needs to be admin for templating access
    ...
    public enum Gauge {
      /// Display numeric states from Be Ready Assistant in a gauge
      public static var description: String { return L10n.tr("Localizable", "widgets.gauge.description") }
      /// Display numeric states from Be Ready Assistant in a gauge. ATTENTION: User needs to be admin for templating access
    ...
    public enum OpenPage {
      /// Open a frontend page in Be Ready Assistant.
